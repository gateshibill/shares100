...
public class CarouselUploadController extends BaseUtil {
	...
	public void upload(@RequestParam(value = "file") CommonsMultipartFile file, HttpServletRequest request,
		...
		String path = request.getServletContext().getRealPath("/") + "carousel" + "/" + filename;// 文件所在盘路径
		String contextPath = request.getContextPath();// 项目名
		String port = request.getServerPort() == 80 ? "" : ":" + request.getServerPort();
		String url = request.getScheme() + "://" + request.getServerName() + port + contextPath + "/carousel/"
				+ filename;
